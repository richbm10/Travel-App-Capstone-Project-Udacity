...
module.exports = (param) => {
    ...
    // router.get('/pages/index/index.js', function(req, res) {
    //     res.sendFile('dist/pages/index/index.js');
    // });

    // router.get('/pages/index/main.css', function(req, res) {
    //     res.sendFile('dist/pages/index/index.css');
    // });
